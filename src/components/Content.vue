  ...
  <template v-else>
    <div class="relative bg-mbeige-base rounded-md flex w-full h-full ">
      <div class="my-auto ml-4 text-3xl text-mgrey-darken-2 max-w-[500px]">
        ...
        <div class="mt-2">
          <button class="cursor-pointer bg-mblue-base text-white rounded-md px-2 py-1 text-lg font-bold hover:bg-mblue-darken-1"
          @click="$emit('highlightFilter')"
          >Pick topics</button>
          <button class="cursor-pointer ml-6 underline text-lg text-mgrey-darken-1 p-2 rounded-md hover:bg-mgrey-lighten-4"
